const REPORT_ARCHIVE = window.__DB.REPORT_ARCHIVE || {};
    ...
    function coreContentItemHtml(item){const title=coreIntro(item.text)||item.title||'具体内容';return '<details class="core-content-item"><summary class="core-content-summary"><div class="core-content-summary-row"><h3 class="core-content-title">'+coreEscapeHtml(title)+'</h3><div class="core-content-summary-actions">'+coreTagHtml(item.type)+'<span class="core-content-arrow" aria-hidden="true">⌄</span></div></div></summary><div class="core-content-body">'+coreHierarchyHtml(item)+'</div></details>'}
    function renderCoreContentModule(id,periodId,archive){const items=coreItemsFor(id,periodId,archive);return '<section class="product-module core-content-module" aria-labelledby="coreContentTitle"><div class="core-content-head"><div><h2 id="coreContentTitle">核心运营内容</h2></div><div class="core-result-count">正文模块 '+items.length+' 条</div></div><div class="core-content-subhead"><h3>具体内容</h3><span>默认收起 · 点击展开</span></div><div class="core-content-list">'+(items.length?items.map(coreContentItemHtml).join(''):'<div class="core-content-empty">该观测日期尚未关联运营内容。</div>')+'</div><dialog class="core-media-lightbox" id="coreMediaDialog" aria-labelledby="coreMediaDialogTitle"><div class="core-media-lightbox-shell"><div class="core-media-lightbox-head"><strong id="coreMediaDialogTitle">原报告配图</strong><button type="button" class="core-media-lightbox-close" aria-label="关闭图片预览">×</button></div><div class="core-media-lightbox-stage"><img alt=""></div><div class="core-media-lightbox-caption"><span></span><span></span></div></div></dialog></section>'}
