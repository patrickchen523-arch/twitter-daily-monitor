...
const BLACKLIST = new Set([
  ...
  '迈从g87v2', '迈从god60', '迈从god60高端系列磁轴键盘', '爱回收', '爱回收严选', '鲤鱼',
  // 动漫/影视角色(非本视频游戏)
  '蜘蛛侠', '超人', '祖国人', '海绵', '海绵宝宝', '派大星',
  // 其他噪声
  '音乐现场', '战友', '野排队友', '黄金精神', '核电站', 'cs', '围棋', '柯洁神之一手',
  '拧不动啊真拧不动', '三国杀移动版激励计划', 'arpg', '逗比', 'rpg', '音乐游戏', '任务',
  '科幻', '太空', 'kpl', 'lpl', '2026lpl第三赛段',
  // 9/14 清洗: 人名/角色/电竞/泛内容标签(非游戏名, 同期 BV 级处理见 bili-overrides.json)
  '鲤鱼ace', '刘慈欣', '时崎狂三', '约会大作战', '总统', 'ig', 'd100', '职场', '剪辑', '混剪',
  '游戏日常', '歌曲', '体育', '烧脑', '钓鱼', '秋叶原', 'pv', '正能量', 'updream', '外星人',
  '猎鹰', '绿龙', '悬疑', '4399', '逆天游戏剧情', '逆天小游戏', '暴雪游戏', '有伊莫不emo',
  '阴阳师拾光永恒', '逆战未来s4朔望赛季', '高燃',
  // 往期清洗(8/26-9/3): 泛内容/活动/UP主标签
  '花滑', '精彩集锦', '国产游戏', '谁是矮玩', '无限大定档', '无限大测试', '异环灵可',
  '三角洲二洲年快乐', '隔壁小蛙', '奥黛塔'
].map(s => s.toLowerCase()));
